...
// Input: Prompts the user for two sets of coordinates. Also prompts user for height.
...
double calculate_perimeter() {
    ...
    // Use calculate_distance to get the distance (radius)
    double radius = calculate_distance();
